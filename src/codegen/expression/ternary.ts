...
function evalTernaryExpression(node: es.ConditionalExpression, env: Environment, lObj: LLVMObjs): l.Value {
    ...
    const testResultValueAddress = lObj.builder.createInBoundsGEP(literalStruct, test, [
      zero,
      one
    ])
