...
entry:
  ...
  %13 = bitcast i8* %12 to %string_literal*
  %14 = getelementptr inbounds %string_literal, %string_literal* %13, i32 0, i32 0
  %15 = getelementptr inbounds %string_literal, %string_literal* %13, i32 0, i32 1
  store double 3.000000e+00, double* %14
  store i8* getelementptr inbounds ([13 x i8], [13 x i8]* @s, i32 0, i32 0), i8** %15
  %16 = bitcast %string_literal* %13 to %literal*
