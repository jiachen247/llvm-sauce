...
entry:
  ...
  %15 = getelementptr inbounds %literal, %literal* %12, i32 0, i32 0
  %16 = getelementptr inbounds %literal, %literal* %12, i32 0, i32 1
  %17 = load double, double* %15
  %18 = load double, double* %16
  %19 = fcmp oeq double %17, 2.000000e+00
  br i1 %19, label %tc.valid, label %tc.error

tc.error:                                         ; preds = %entry
  call void @error(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @0, i32 0, i32 0))
  call void @exit(i32 1)
  br label %tc.valid

tc.valid:                                         ; preds = %tc.error, %entry
  %20 = fptosi double %18 to i1
  %21 = xor i1 %20, true
  ...
  store double 2.000000e+00, double* %25
  store double %22, double* %26
  call void @display(%literal* %24)
  ret i32 0
}
