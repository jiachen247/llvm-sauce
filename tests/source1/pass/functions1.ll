...
f.entry:                                          ; preds = %f.setup
  ...
  %11 = bitcast i8* %10 to %string_literal*
  %12 = getelementptr inbounds %string_literal, %string_literal* %11, i32 0, i32 0
  %13 = getelementptr inbounds %string_literal, %string_literal* %11, i32 0, i32 1
  store double 3.000000e+00, double* %12
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @s, i32 0, i32 0), i8** %13
  %14 = bitcast %string_literal* %11 to %literal*
  call void @display(%literal* %14)
  ret %literal* %7
}
